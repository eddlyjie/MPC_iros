...
from environment_benchmark import RLEnvironment
...
def evaluate():
          ...
          """
          print("--- Initializing Benchmark Evaluation Environment ---")

          # --- Configurable Parameters ---
          N_EVAL_EPISODES = 1 # Number of episodes to run for evaluation
          ...
          VIDEO_DIR = "benchmark_videos" # Directory to save videos
          SAVE_MATFILE = True # <-- ADDED: Whether to save vehicle states to a .mat file
          MATFILE_DIR = "benchmark_data" # <-- ADDED: Directory to save .mat files
          ...
          try:
                    for i in range(N_EVAL_EPISODES):
                              ...
                              # <-- ADDED: Lists to store states for this episode
                              episode_states_car1 = []
                              episode_states_car2 = []
                              ...
                              while not terminated and not truncated:
                                        ...
                                        # --- Store states for matfile saving ---
                                        # (Store them in variables to also pass to visualization)
                              ...
                              if SAVE_MATFILE:
                                        try:
                                                  mat_filename = os.path.join(MATFILE_DIR, f"model_{MODEL_SUFFIX}_episode_{i+1}_states.mat")
